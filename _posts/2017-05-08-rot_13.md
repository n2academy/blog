...
lashte enkriptimi, emeruar pas Jul Çezarit, i cili e perdorte per te enkriptuar mesazhet e tij private ne kohen e Perandorise Romake. Ne kete ushtrim do te mesojme:
  ...
  3. (Bonus) Si ta thyejme kete metode enkriptimi
...
## Si te enkriptojme nje mesazh duke perdorur `ROT13`
...
Funksioni `modulo` ne python shprehet me operatorin `%`.
...
## (Bonus) Si ta thyejme kete metode enkriptimi
